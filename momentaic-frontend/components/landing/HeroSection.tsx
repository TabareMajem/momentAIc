...
export const HeroSection = () => {
 ...
 >
 Scale <br />
 <span className="text-transparent bg-clip-text bg-[#111111] from-purple-400 via-white animate-gradient bg-[length:200%_auto]">
 Infinite.
 </span>
 </h1>
 ...
 <Link to="/signup">
 <Button className="h-14 px-8 text-lg bg-white text-black hover:bg-gray-200 font-bold rounded-xl transition-all hover:scale-105 btn-brand text-white border-0">
 ...
 <div className="absolute -inset-1 bg-[#111111] from-purple-600 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
 <AgentCommandCenter />
 </div>
 </div>
