...
export function InevitabilitySection() {
 ...
 The Pedigree Paradox is <span className="text-transparent bg-clip-text bg-[#111111] from-red-500 ">Over.</span>
 </h2>
 ...
 <div className="bg-[#0A0A0A] border border-white/10 p-6 clip-corner-2 relative overflow-hidden group hover:border-[#222222] transition-colors">
 ...
 <div className="relative bg-[#0A0A0A]/80 backdrop-blur-xl border border-white/10 p-8 rounded-2xl ">
 ...
 <div className="h-full bg-[#111111] from-purple-600 w-[95%] relative">
 <div className="absolute top-0 right-0 h-full w-20 bg-[#111111] from-transparent to-white/50 animate-glowX" />
 </div>
 </div>
 </div>
