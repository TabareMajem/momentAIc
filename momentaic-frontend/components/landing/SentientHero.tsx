...
const RotatingKeywords = () => {
 ...
 key={word}
 className={cn(
 "absolute transition-all duration-700 ease-in-out font-black text-transparent bg-clip-text bg-[#111111] from-purple-400 bg-300% animate-gradient",
...
const FloatingCard = ({ delay, posObj, children, className }: any) => (
 <div
 className={cn(
 "absolute hidden lg:flex flex-col bg-[#0A0A0A]/80 backdrop-blur-xl border border-white/10 p-4 clip-corner-2 animate-float transition-transform duration-300",
 className
 )}
 style={{
...
export function SentientHero() {
 ...
 <div className="absolute inset-0 bg-[#111111] from-transparent via-[#020202]/80 to-[#020202] z-1 pointer-events-none" />
 <div className="absolute top-0 w-full h-px bg-[#111111] from-transparent to-transparent z-10" />
 ...
 {/* Status Pill */}
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/40 bg-purple-500/10 text-purple-200 font-mono text-xs mb-10 animate-fade-in-up backdrop-blur-md ">
 ...
 <Button className="w-full sm:w-auto h-16 px-10 text-base font-bold font-mono bg-white text-black hover:bg-purple-500 hover:text-white transition-all clip-corner-4 group-hover:">
