...
export function ProtocolShowcase() {
 ...
 <div className="h-full bg-[#0A0A0A] border border-white/10 rounded-xl relative overflow-hidden p-8 flex flex-col">
 {/* Header */}
 ...
 <div className={cn(
 "w-16 h-16 rounded-xl flex items-center justify-center border-2 transition-all duration-500 mb-4 bg-[#0A0A0A]",
 isActive
