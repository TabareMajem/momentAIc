...
export function EcosystemSection() {
 ...
 className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#222222] bg-purple-500/10 text-purple-400 font-mono text-xs mb-8 "
 >
 <Share2 className="w-4 h-4" />
 UNIVERSAL_CLIENT_PROTOCOL
 </motion.div>
 <h2 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-[#111111] from-white tracking-tighter mb-6">
 The Neural Ecosystem
 </h2>
 <p className="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl font-light leading-relaxed">
 MomentAIc isn't just a chatbot. It's an <span className="text-transparent bg-clip-text bg-[#111111] from-purple-400 font-mono font-medium">Operating System</span> that connects directly to your tools via the Model Context Protocol (MCP).
 </p>
 </motion.div>
 ...
 >
 <IntegrationNode icon={<Globe />} label="Google Workspace" color="text-blue-400" border="border-[#222222]" glow="" />
 </motion.div>
 ...
 whileHover={{ scale: 1.05, zIndex: 30 }}
 >
 <IntegrationNode icon={<CreditCard />} label="Stripe Finance" color="text-green-400" border="border-green-500/30" glow="" />
 </motion.div>
 ...
 whileHover={{ scale: 1.05, zIndex: 30 }}
 >
 <IntegrationNode icon={<Github />} label="Git Repositories" color="text-gray-300" border="border-white/30" glow="" />
 </motion.div>
 ...
 whileHover={{ scale: 1.05, zIndex: 30 }}
 >
 <IntegrationNode icon={<Database />} label="Postgres Data" color="text-yellow-400" border="border-yellow-500/30" glow="" />
 </motion.div>
 </div>

 {/* Mobile Nodes Grid */}
 <div className="md:hidden grid grid-cols-2 gap-4 w-full relative z-30 mt-32 px-4">
 <IntegrationNode icon={<Globe />} label="Workspace" color="text-blue-400" border="border-[#222222]" glow="" />
 <IntegrationNode icon={<CreditCard />} label="Finance" color="text-green-400" border="border-green-500/30" glow="" />
 <IntegrationNode icon={<Github />} label="Git Repos" color="text-gray-300" border="border-white/30" glow="" />
 <IntegrationNode icon={<Database />} label="Database" color="text-yellow-400" border="border-yellow-500/30" glow="" />
 </div>
 ...
 className="absolute md:relative z-20 w-40 h-40 md:w-56 md:h-56 bg-[#030303] border border-purple-500/40 rounded-full flex items-center justify-center backdrop-blur-xl -top-20 md:top-auto"
 >
 <motion.div
 ...
 <motion.div
 className="w-12 h-12 md:w-16 md:h-16 mx-auto bg-[#111111] from-purple-500/20 rounded-2xl flex items-center justify-center mb-3 border border-[#222222] "
 animate={{ rotate: 360 }}
 transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
 >
 <div className="w-6 h-6 md:w-8 md:h-8 bg-black/80 rounded-lg border border-purple-500/50" />
 </motion.div>
 <div className="text-xl md:text-3xl font-black text-transparent bg-clip-text bg-[#111111] from-purple-300 via-white tracking-tight">CORE</div>
...
function IntegrationNode({ icon, label, color, border, glow }: any) {
 return (
 <div className={cn(
 "w-full md:w-36 md:h-36 bg-[#0A0A0A]/90 backdrop-blur-xl border rounded-2xl flex flex-row md:flex-col items-center justify-start md:justify-center p-4 transition-all duration-500 group cursor-default relative overflow-hidden",
 border, glow
 )}>
 <div className="absolute inset-0 bg-[#111111] from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
