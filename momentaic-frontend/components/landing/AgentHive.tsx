...
export function AgentHive() {
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#222222] bg-purple-500/10 text-purple-400 font-mono text-xs mb-6">
 ...
 {/* Card Body */}
 <div className={cn(
 "w-full h-full border bg-[#0A0A0A] flex flex-col items-center justify-center p-2 relative overflow-hidden clip-corner-1 transition-colors",
