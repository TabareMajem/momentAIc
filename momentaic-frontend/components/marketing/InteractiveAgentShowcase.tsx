...
export function InteractiveAgentShowcase() {
 ...
 <div className="p-6 border-b border-white/5 bg-[#111111] to-transparent flex justify-between items-center">
 <div>
 ...
 <div className="flex-1 bg-[#0A0A0A] rounded-md border border-white/10 p-3 font-mono text-[10px] overflow-y-auto w-full">
 ...
 {/* Right: Visual Nodes */}
 <div className="flex-1 p-8 relative flex items-center justify-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] via-[#0a0a0a] to-[#0a0a0a]">
 <div className="relative w-full h-full max-w-md">
 {/* Central Hub */}
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-purple-500/10 border-2 border-purple-500/50 rounded-full flex items-center justify-center z-10">
 ...
 agent.state === 'processing' ? `bg-black border-white ${agent.color} animate-pulse` :
 `bg-black/80 ${agent.color} border-current `
 )}>
