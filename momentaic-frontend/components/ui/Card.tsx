...
export function Card({ className, children, ...props }: React.HTMLAttributes<HTMLDivElement>) {
 ...
 {/* Hover Glow Gradient */}
 <div className="absolute -inset-px bg-[#111111] from-[#00f0ff]/0 via-[#00f0ff]/10 to-[#00f0ff]/0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
