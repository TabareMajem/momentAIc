...
export function SymbioTaskVideoModal({ isOpen, onClose, imageUri, prompt }: SymbioTaskVideoModalProps) {
 ...
 className="relative w-full max-w-2xl bg-[#0A0A0A] border border-[#222222] rounded-2xl shadow-2xl overflow-hidden"
 >
 {/* Header */}
 <div className="p-6 border-b border-white/5 flex justify-between items-center bg-[#111111] to-transparent">
 <div className="flex items-center gap-3">
 <div className="p-2 bg-[#111111] from-purple-500 rounded-lg shadow-lg">
 ...
 {/* CTA Card */}
 <div className="bg-[#111111] to-black border border-[#222222] rounded-xl p-6 text-center shadow-[inset_0_0_20px_rgba(168,85,247,0.15)] relative overflow-hidden">
 ...
 <Button className="px-8 h-12 text-sm bg-[#111111] from-purple-500 hover:from-purple-400 hover: text-white font-bold rounded-xl hover: transition-all flex items-center gap-2">
