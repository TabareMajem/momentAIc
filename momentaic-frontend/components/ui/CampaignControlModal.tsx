...
export function CampaignControlModal({ isOpen, onClose }: CampaignControlModalProps) {
 ...
 <div className="relative z-10 w-full max-w-6xl max-h-[90vh] bg-[#0A0A0A]/90 backdrop-blur-md border border-[#222222] rounded-xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-300">
 {/* Header */}
 ...
 <div className="p-4 bg-black/40 border border-[#222222] rounded-xl relative overflow-hidden">
 <div className="absolute top-0 right-0 w-16 h-16 bg-[#111111] from-purple-500/20 to-transparent blur-xl" />
