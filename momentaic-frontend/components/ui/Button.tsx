...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
 ...
 cyber: 'btn-brand text-white border border-transparent relative overflow-hidden group',
 ...
 >
 {variant === 'cyber' && (
 <div className="absolute inset-0 translate-x-[-100%] group-hover:animate-shimmer bg-[#111111] from-transparent via-white/10 to-transparent pointer-events-none" />
 )}
