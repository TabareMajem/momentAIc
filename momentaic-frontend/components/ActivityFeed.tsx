...
function ActivityCard({
 ...
 content: 'from-purple-500 ',
 sdr: 'from-blue-500 ',
 growth_hacker: 'from-green-500 ',
 marketing: 'from-orange-500 ',
 };
 return colors[activity.agent] || 'from-slate-500 ';
 };
 ...
 return (
 <div className="relative flex gap-4 p-4 rounded-xl bg-[#111111]/50 border border-white/5 hover:border-white/10 transition-all animate-fade-in">
 {/* Agent Avatar */}
 <div className={`flex-shrink-0 w-10 h-10 rounded-lg bg-[#111111] ${getAgentColor()} flex items-center justify-center`}>
 ...
 {activity.content && (
 <div className="bg-[#1A1A1A]/50 rounded-lg p-3 text-sm text-slate-400 mb-3">
...
export default function ActivityFeed() {
 ...
 {/* Footer */}
 <div className="p-3 border-t border-white/5 bg-[#111111]/30">
