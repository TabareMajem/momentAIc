...
export function ActionQueueWidget() {
 ...
 return (
 <div className="bg-[#111111]/50 rounded-xl border border-white/5 p-6 flex justify-center items-center h-48">
 ...
 if (actions.length === 0) {
 return (
 <div className="bg-[#111111]/50 rounded-xl border border-white/5 p-6 flex flex-col items-center justify-center h-48 text-center">
 <div className="w-12 h-12 bg-[#1A1A1A]/50 rounded-full flex items-center justify-center mb-3 border border-white/5">
 ...
 return (
 <div className="bg-[#111111]/50 rounded-xl border border-rose-500/20 overflow-hidden relative ">
 {/* Background glow for urgent feel */}
 <div className="absolute top-0 left-0 w-full h-1 bg-[#111111] from-rose-500 "></div>

 <div className="p-4 border-b border-white/5 flex items-center justify-between bg-[#1A1A1A]/20">
 ...
 {actions.map((action) => (
 <div key={action.id} className="p-4 hover:bg-[#1A1A1A]/30 transition-colors group">
 <div className="flex items-start justify-between gap-4">
 <div className="flex items-start gap-3 flex-1 min-w-0">
 <div className="mt-1 p-2 bg-[#1A1A1A] rounded-lg border border-white/5">
 ...
 className="p-1.5 text-slate-400 hover:text-red-400 hover:bg-[#1A1A1A] rounded-lg transition-colors"
 title="Reject"
 >
 ...
 className="p-1.5 text-slate-400 hover:text-emerald-400 hover:bg-[#1A1A1A] rounded-lg transition-colors"
 title="Approve"
 >
