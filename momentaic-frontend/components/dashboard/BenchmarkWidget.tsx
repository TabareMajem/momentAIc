...
export function BenchmarkWidget() {
 ...
 return (
 <div className="bg-[#0A0A0A] border border-white/5 rounded-xl p-4 h-48 animate-pulse flex flex-col justify-center items-center">
 ...
 return (
 <div className="bg-[#0A0A0A] border border-white/5 rounded-xl p-4 h-48 flex flex-col justify-center items-center text-center">
 ...
 return (
 <div className="bg-[#0A0A0A] border border-white/10 rounded-xl p-5 shadow-lg group hover:border-[#bf25eb]/30 transition-colors">
 ...
 {/* Top 10 Marker */}
 <div
 className="absolute top-0 bottom-0 w-px bg-[#00f0ff]/50 z-10 hover:bg-[#00f0ff] hover:w-0.5 transition-all "
