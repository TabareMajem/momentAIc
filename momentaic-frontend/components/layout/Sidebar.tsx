...
export function Sidebar() {
 ...
 {isActive && (
 <div className="absolute right-0 inset-y-0 w-1 bg-[#111111] from-brand-purple to-brand-cyan rounded-l-full" />
 )}
 </Link>
 );
 };
 ...
 ? "text-white bg-purple-500/10 border border-[#222222]"
 ...
 <div className="h-20 flex items-center px-6 border-b border-white/5 bg-[#0A0A0A]">
 <Logo />
 </div>
