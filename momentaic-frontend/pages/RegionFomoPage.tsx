...
export default function RegionFomoPage() {
 ...
 return (
 <div className={`min-h-screen bg-[#111111] ${region.gradient} text-white relative overflow-hidden font-sans selection:bg-white/30`}>
 ...
 <div
 className="h-full bg-[#111111] from-red-500 transition-all duration-1000 ease-out"
 ...
 className="w-full py-4 rounded-xl bg-white text-black font-bold text-lg hover:bg-white/90 transform hover:translate-y-[-2px] transition-all disabled:opacity-50 disabled:hover:translate-y-0 flex items-center justify-center gap-2 group-hover:"
 >
 {isSubmitting ? (
 'Securing Spot...'
 ) : (
