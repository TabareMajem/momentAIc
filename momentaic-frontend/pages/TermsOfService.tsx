...
export default function TermsOfService() {
 ...
 <div className="w-8 h-8 rounded bg-[#111111] from-[#00f0ff] to-[#0047ff] flex items-center justify-center font-bold text-black text-xl">M</div>
 <span className="text-xl font-bold bg-clip-text text-transparent bg-[#111111] from-white ">
 MomentAIc
 </span>
 </Link>
 </div>
 ...
 <div className="relative w-24 h-24 rounded-full overflow-hidden border border-[#00f0ff]/30 ">
