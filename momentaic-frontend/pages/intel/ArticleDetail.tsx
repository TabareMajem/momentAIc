...
export default function ArticleDetail() {
 ...
 <div className="fixed top-0 left-0 w-full h-1 bg-[#111111] from-purple-600 z-50 animate-pulse-slow" />
 ...
 <h1 className="text-4xl md:text-6xl font-black tracking-tight mb-6 bg-clip-text text-transparent bg-[#111111] from-white ">
 {article.title}
 </h1>
 ...
 <div className="w-8 h-8 rounded-full border border-[#222222] overflow-hidden bg-purple-900/20 flex items-center justify-center text-purple-400">
 ...
 <div className="relative w-full aspect-video rounded-2xl overflow-hidden mb-16 border border-white/10 shadow-2xl group">
 <div className="absolute inset-0 bg-[#111111] from-black/80 to-transparent z-10" />
 <img
