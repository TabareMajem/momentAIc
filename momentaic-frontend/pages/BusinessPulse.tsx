...
const STATUS_COLORS: Record<string, { bg: string; border: string; text: string; glow: string }> = {
 ...
 INSIGHT: { bg: 'bg-blue-500/10', border: 'border-[#222222]', text: 'text-blue-400', glow: '' },
...
export default function BusinessPulse() {
 ...
 <div className="w-10 h-10 bg-purple-500/20 rounded-lg flex items-center justify-center border border-[#222222]">
 ...
 <div className="relative border border-green-500/20 bg-black/40 backdrop-blur-md rounded-2xl p-6 ">
 ...
 <h2 className="text-xl font-black font-mono text-transparent bg-clip-text bg-[#111111] from-green-400 tracking-tight">REVENUE COMMAND CENTER</h2>
 ...
 <div className="bg-[#111111] from-green-900/30 border border-green-500/30 rounded-lg p-5 relative overflow-hidden group hover:border-green-400/50 transition-all">
 ...
 <div className="bg-[#111111] border border-[#222222] rounded-lg p-5 relative overflow-hidden group hover:border-blue-400/50 transition-all">
 ...
 <div className="bg-[#111111] from-red-900/30 border border-red-500/30 rounded-lg p-5 relative overflow-hidden group hover:border-red-400/50 transition-all">
 ...
 <div className="bg-[#111111] border border-[#222222] rounded-lg p-5 relative overflow-hidden group hover:border-purple-400/50 transition-all">
