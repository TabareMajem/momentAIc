...
const GraphNode: React.FC<GraphNodeProps> = ({ node, selected, onClick }) => {
 ...
 if (node.data.status === 'running') return 'border-[#00f0ff] ';
 if (node.data.status === 'completed') return 'border-green-500 ';
...
export default function AgentForge() {
 ...
 <div className="p-2 bg-[#111111] from-purple-500 rounded-lg">
 ...
 <Badge variant="secondary" className="bg-[#111111] from-purple-500/20 border-[#222222] text-cyan-400 ml-2">
 PREMIUM ACCESS
 </Badge>
 )}
 </div>
 ...
 variant="cyber"
 size="lg"
 className="bg-[#111111] from-purple-600 hover:from-purple-500 hover: border-0 text-white min-w-[200px]"
 ...
 <Button variant="outline" size="sm" onClick={() => setShowImportModal(true)} className="border-[#222222] text-purple-400 hover:bg-purple-500/10 whitespace-nowrap">
 ...
 {/* Graph Canvas */}
 <div className="flex-1 bg-[#0A0A0A] rounded-xl border border-white/10 relative overflow-hidden shadow-inner group">
 {/* Grid Background */}
 ...
 <div className="bg-[#0A0A0A] border border-[#222222] w-full max-w-2xl rounded-xl overflow-hidden flex flex-col">
 ...
 <div key={agent.id} className="flex items-center justify-between p-4 rounded-lg border border-white/5 bg-white/5 hover:border-[#222222] hover:bg-purple-500/5 transition-all group">
 <div>
 <h4 className="font-bold text-white font-mono flex items-center gap-2">
 {agent.name}
 <Badge variant="outline" className="text-xs font-mono text-purple-400 border-[#222222]">
 ...
 <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
 <div className="bg-[#0A0A0A] border border-cyan-500/30 w-full max-w-xl rounded-xl overflow-hidden flex flex-col">
