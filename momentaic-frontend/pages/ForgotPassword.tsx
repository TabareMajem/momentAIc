...
export default function ForgotPassword() {
 ...
 <Card className="border-white/10 bg-[#0A0A0A]/80 backdrop-blur-xl ">
 <CardHeader className="text-center pb-8 border-b border-white/5">
 <div className="mx-auto w-12 h-12 bg-[#a855f7]/10 rounded-full flex items-center justify-center mb-4 border border-[#a855f7]/20 ">
 ...
 type="submit"
 variant="cyber"
 className="w-full h-12 text-sm border-[#a855f7] text-[#a855f7] hover:bg-[#a855f7] hover:text-black"
 isLoading={isLoading}
 >
 SEND RECOVERY LINK
 </Button>
