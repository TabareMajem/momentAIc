...
function PowerPlayCard({
 ...
 className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#111111]/50 backdrop-blur-xl"
 >
 {/* Gradient Header */}
 <div className={`h-2 bg-[#111111] ${play.gradient}`} />

 <div className="p-6">
 {/* Icon & Title */}
 <div className="flex items-start gap-4 mb-4">
 <div className={`p-3 rounded-xl bg-[#111111] ${play.gradient} bg-opacity-20`}>
 ...
 <span className="px-2 py-1 rounded-md bg-[#1A1A1A] text-xs text-slate-300 capitalize">
 {agent.replace('_', ' ')}
 </span>
 ...
 className={`bg-[#111111] ${play.gradient}`}
 >
 {isExecuting ? (
 <>
...
export default function PowerPlays() {
 ...
 return (
 <div className="min-h-screen bg-[#111111] from-slate-950 p-8">
 {/* Header */}
 ...
 >
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#111111] from-purple-500/20 border border-[#222222] mb-6">
 ...
 <div className="bg-[#111111]/50 rounded-xl border border-white/10 p-6">
