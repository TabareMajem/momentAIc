...
export default function FromLovable() {
 ...
 {/* Animated Background */}
 <div className="fixed inset-0 bg-[#111111] via-transparent pointer-events-none" />
 <div className="fixed inset-0 bg-[url('/grid.svg')] opacity-5 pointer-events-none" />

 {/* Hero */}
 <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
 {/* Badge */}
 <div className="mb-8 flex items-center gap-2 px-4 py-2 bg-purple-500/10 border border-[#222222] rounded-full text-purple-400 text-sm font-mono animate-pulse">
 ...
 You built it in
 <span className="bg-[#111111] from-[#00f0ff] bg-clip-text text-transparent"> 10 minutes</span>.
 <br />
 Now get your first
 <span className="bg-[#111111] from-purple-500 bg-clip-text text-transparent"> 10 users</span>.
 </h1>
 ...
 className="w-full bg-black/50 border-2 border-[#222222] rounded-2xl px-6 py-5 pr-16 text-white text-lg placeholder-gray-600 focus:outline-none focus:border-[#00f0ff] focus:ring-2 focus:ring-[#00f0ff]/20 transition-all font-mono"
 />
 <button
 onClick={handleLaunch}
 disabled={!url.trim()}
 className="absolute right-3 top-3 p-3 bg-[#111111] from-[#00f0ff] rounded-xl text-black hover:opacity-90 disabled:opacity-50 transition-all shadow-lg "
 >
 ...
 <Button
 onClick={handleLaunch}
 className="bg-[#111111] from-[#00f0ff] text-black font-black text-lg px-12 py-6 rounded-2xl hover: transition-all"
 >
