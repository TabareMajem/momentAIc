...
const TIER_CONFIG = {
 ...
 growth: { label: 'GROWTH', color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-[#222222]', glow: '' },
 godmode: { label: 'GOD MODE', color: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-[#222222]', glow: '' },
};
...
export default function FeatureArsenal() {
 ...
 <button
 onClick={enableAll}
 className="px-4 py-2 text-[10px] font-mono font-bold uppercase tracking-widest bg-purple-500/10 border border-[#222222] text-purple-400 hover:bg-purple-500/20 rounded-lg transition-all"
 >
 Unlock All
 </button>
 </div>
 ...
 <div
 className="h-full bg-[#111111] from-emerald-500 rounded-full transition-all duration-500"
