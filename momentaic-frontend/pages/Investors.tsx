...
export default function InvestorsPage() {
 ...
 <div>
 <h1 className="text-3xl font-bold bg-[#111111] from-white bg-clip-text text-transparent">
 ...
 <Card className="bg-[#0A0A0A] border-purple-500/20 relative overflow-hidden">
 ...
 <Card className="bg-[#0A0A0A] border-blue-500/20 relative overflow-hidden">
 ...
 <Card className="bg-[#0A0A0A] border-red-500/20 relative overflow-hidden">
 ...
 <Card className="bg-[#0A0A0A] border-green-500/20 relative overflow-hidden">
