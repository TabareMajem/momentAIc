...
const TIERS = {
 rocket: { color: 'from-purple-500 ', icon: '🚀', label: 'Rocket' },
 scaling: { color: 'from-blue-500 ', icon: '📈', label: 'Scaling' },
 rising: { color: 'from-green-500 ', icon: '🌱', label: 'Rising' },
 building: { color: 'from-yellow-500 ', icon: '🔨', label: 'Building' },
 ideation: { color: 'from-gray-500 ', icon: '💡', label: 'Ideation' },
};
...
export default function LeaderboardPage() {
 ...
 {/* Anti-YC Banner */}
 <div className="mb-8 p-6 bg-[#111111] border border-[#222222] rounded-2xl">
 ...
 className="px-4 py-2 bg-gray-800/50 border border-[#222222] rounded-xl text-white text-sm"
 >
 {CATEGORIES.map((cat) => (
 ...
 {/* Leaderboard Table */}
 <div className="bg-gray-800/30 rounded-2xl border border-[#222222]/50 overflow-hidden">
 {/* Header */}
 ...
 className="grid grid-cols-12 gap-4 p-4 border-t border-[#222222]/30 hover:bg-gray-800/30 transition cursor-pointer"
 >
 {/* Rank */}
 ...
 <div className={`px-3 py-1 rounded-full bg-[#111111] ${tierInfo.color} text-white font-bold text-sm`}>
 ...
 <span className={`px-2 py-1 rounded text-xs ${tierInfo.color} bg-[#111111] text-white`}>
 {tierInfo.label}
 </span>
 ...
 {/* CTA */}
 <div className="mt-12 p-8 bg-[#111111] from-green-900/30 border border-green-500/30 rounded-2xl text-center">
