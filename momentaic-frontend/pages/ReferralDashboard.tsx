...
const MILESTONES = [
 { count: 5, name: 'Starter', reward: 250, badge: '🌱', color: 'from-green-500/20 ' },
 { count: 10, name: 'Rising Star', reward: 500, badge: '⭐', color: 'from-yellow-500/20 ' },
 { count: 25, name: 'Growth Master', reward: 1000, badge: '🚀', color: 'from-blue-500/20 ' },
 { count: 50, name: 'Viral Legend', reward: 2500, badge: '🔥', color: 'from-orange-500/20 ' },
 { count: 100, name: 'Unicorn Hunter', reward: 5000, badge: '🦄', color: 'from-purple-500/20 ' },
];
...
function MilestoneCard({
 ...
 <div
 className="h-full bg-[#111111] from-[#00f0ff] to-[#00f0ff]/50 transition-all duration-500"
...
function Leaderboard({ entries }: { entries: LeaderboardEntry[] }) {
 ...
 idx < 3 ? "bg-[#111111] from-[#00f0ff]/10 to-transparent border border-[#00f0ff]/20" : "bg-black/30"
 )}
 >
 <div className={cn(
...
export default function ReferralDashboard() {
 ...
 <Card className="p-4 bg-[#111111] from-[#00f0ff]/10 to-transparent border-[#00f0ff]/20">
 ...
 <Card className="p-4 bg-[#111111] from-green-500/10 to-transparent border-green-500/20">
 ...
 <Card className="p-4 bg-[#111111] from-purple-500/10 to-transparent border-purple-500/20">
 ...
 <Card className="p-4 bg-[#111111] from-orange-500/10 to-transparent border-orange-500/20">
 ...
 {/* Referral Link Card */}
 <Card className="p-6 bg-[#111111] from-[#00f0ff]/5 to-transparent border-[#00f0ff]/20">
 ...
 <div
 className="h-full bg-[#111111] from-[#00f0ff] to-[#00f0ff]/50 transition-all duration-500 relative"
 style={{ width: `${stats.next_milestone.progress_percent}%` }}
 >
 <div className="absolute inset-0 bg-[#111111] from-transparent via-white/20 to-transparent animate-shimmer" />
 </div>
 </div>
 </div>
