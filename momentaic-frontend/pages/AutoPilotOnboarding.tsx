...
function AgentTerminal({ logs }: { logs: string[] }) {
 ...
 return (
 <div className="bg-slate-950 rounded-lg p-4 font-mono text-xs md:text-sm text-emerald-400 border border-[#222222] h-64 overflow-y-auto shadow-inner" ref={scrollRef}>
 {logs.map((log, i) => (
...
export default function AutoPilotOnboarding() {
 ...
 <h1 className="text-4xl md:text-6xl font-black text-transparent bg-clip-text bg-[#111111] from-white mb-6 tracking-tight">
 Command the Swarm.
 </h1>
 ...
 className="w-full px-6 py-4 rounded-xl bg-[#111111]/50 border border-[#222222] text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 text-lg transition-all"
 autoFocus
 />
 <textarea
 ...
 rows={2}
 className="w-full px-6 py-4 rounded-xl bg-[#111111]/50 border border-[#222222] text-white placeholder-slate-600 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 resize-none transition-all"
 />
 <button
 onClick={handleStart}
 className="w-full py-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-lg flex items-center justify-center gap-2 transition-all shadow-lg "
 >
 Deploy Agents
 ...
 <div className="w-6 h-6 rounded-full border border-[#222222] bg-[#1A1A1A]/50" />
 )}
