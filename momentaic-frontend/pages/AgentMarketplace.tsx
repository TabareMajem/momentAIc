...
export default function AgentMarketplace() {
 ...
 {/* Header */}
 <div className="mb-8 p-6 bg-[#111111] border border-white/5 rounded-2xl relative overflow-hidden">
 ...
 {[1, 2, 3].map(i => (
 <div key={i} className="bg-[#0A0A0A] border border-white/5 rounded-xl h-64" />
 ))}
 </div>
 ) : templates.length === 0 ? (
