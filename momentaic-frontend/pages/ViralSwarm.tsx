...
export default function ViralSwarm() {
 ...
 <div className="absolute inset-0 bg-[#111111] from-purple-600 to-[#00f0ff] opacity-0 group-hover:opacity-20 transition-opacity" />
 </Button>
 </div>
 ...
 {/* Image Container */}
 <div className="h-64 relative overflow-hidden bg-[#111111] border-b border-white/10">
 {asset.image_url ? (
 <>
