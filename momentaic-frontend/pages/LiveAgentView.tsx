...
const AGENT_CONFIG = {
 'Siren': { icon: Sparkles, color: 'from-pink-500 ', desc: 'Content & Growth' },
 'Hunter': { icon: Users, color: 'from-blue-500 ', desc: 'Sales & Leads' },
 'Builder': { icon: Zap, color: 'from-yellow-500 ', desc: 'Dev & Ops' },
 'Strategist': { icon: TrendingUp, color: 'from-green-500 ', desc: 'Analysis' },
};
...
export default function LiveAgentView() {
 ...
 <div className="p-3 rounded-xl bg-[#111111] from-purple-500/20 border border-white/10">
 ...
 <div className={`p-2 rounded-lg bg-[#111111] ${config.color}`}>
 ...
 >
 <div className={`p-2 rounded-lg bg-[#111111] ${agentConfig.color} shrink-0`}>
