...
const ALLOCATION = [
 { pct: 60, usd: "$180,000", label: "Algorithmic Reinvestment", color: "from-purple-600 ", desc: "Direct capital deployment into top-1% founders via Signal Score. We co-invest before Series A framing exists." },
 { pct: 30, usd: "$90,000", label: "Swarm Acquisition Engine", color: "from-blue-600 ", desc: "Fueling the Hourly Hunters, Character Factory offensive, and Ambassador network to flood the top of funnel." },
 { pct: 10, usd: "$30,000", label: "Infrastructure Supremacy", color: "from-green-600 ", desc: "LLM API overhead, VPS hardening, database scaling, and agent orchestration layer to run 24/7 zero-downtime." },
];
...
export default function InvestorDeck() {
 ...
 <div className="w-6 h-6 bg-[#111111] from-red-500 rounded-sm" />
 ...
 <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-red-500/10 border border-red-500/50 text-red-400 font-mono text-[10px] sm:text-xs mb-10 tracking-[0.4em] uppercase backdrop-blur-md ">
 ...
 Vibe Coding the<br />
 <span className="text-transparent bg-clip-text bg-[#111111] from-red-500 animate-pulse">
 Inevitability.
 </span>
 </h1>

 <p className="text-xl md:text-3xl text-gray-300 max-w-4xl mx-auto mb-6 font-mono leading-relaxed font-semibold">
 We didn't just build an <strong className="text-white drop-">Autonomous Business OS</strong>.<br />
 We built the <strong className="text-transparent bg-clip-text bg-[#111111] from-red-400 ">Signal Engine</strong> that detects the top 1% of founders before anyone else.
 </p>
 ...
 className="h-16 px-12 text-sm font-black font-mono bg-white text-black hover:bg-black hover:text-white border-2 border-transparent hover:border-white transition-all flex items-center justify-center gap-3 uppercase tracking-widest hover: relative group overflow-hidden"
 >
 ...
 <div className="absolute -inset-0.5 bg-[#111111] from-red-500 opacity-20 blur-xl z-[-1]" />
 {MARKET_STATS.map((s, i) => (
 <div key={i} className="bg-black/80 p-8 text-center hover:bg-red-950/20 transition-colors duration-500 group">
 <div className="text-3xl md:text-5xl font-black text-white mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-[#111111] group-hover:from-white group-hover: transition-all">{s.value}</div>
 ...
 <div className="absolute inset-0 bg-[#111111] from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
 ...
 <div className="inline-block border border-[#222222] bg-purple-500/10 text-purple-400 px-3 py-1 font-mono text-[10px] tracking-[0.4em] mb-6 uppercase">The Operating System</div>
 ...
 <h2 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[0.85] drop-shadow-2xl">
 The Cap Table is<br />
 <span className="text-transparent bg-clip-text bg-[#111111] from-red-500 ">
 Pre-computed.
 </span>
 </h2>
 </div>
 ...
 { label: "MomentAIc Signal Score™", pct: 97, color: "bg-[#111111] from-purple-600 ", tag: "Real-Time · Proprietary" },
 ].map((item, i) => (
 <div key={i}>
 ...
 <span className="text-red-500 drop-">We play offense.</span>
 </h2>
 ...
 Deploying<br />
 <span className="text-transparent bg-clip-text bg-[#111111] from-yellow-400 ">
 Asymmetric Capital.
 </span>
 </h2>
 </div>
 ...
 <div className="h-2 w-full bg-white/5 rounded-full overflow-hidden">
 <div className={`h-full bg-[#111111] ${a.color}`} style={{ width: `${a.pct}%` }} />
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="inline-block border border-[#222222] bg-blue-500/10 text-blue-400 px-3 py-1 font-mono text-[10px] tracking-[0.4em] mb-6 uppercase">Phase 6: Timeline</div>
 ...
 <div className="relative">
 <div className="absolute inset-0 bg-[#111111] from-red-900/20 blur-3xl rounded-full" />
 ...
 <div className="absolute bottom-0 left-0 right-0 bg-[#111111] from-black via-black/70 to-transparent p-6 z-20">
 ...
 <Link to="/research" className="h-10 px-5 border border-[#222222] hover:border-purple-500 text-purple-400 hover:text-white font-mono text-xs uppercase tracking-widest flex items-center gap-2 transition-all">
 ...
 <div className="bg-[#0A0A0A] border border-red-500/20 overflow-hidden">
