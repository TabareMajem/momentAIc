...
export default function WarRoomDashboard() {
 ...
 <div className="mb-12">
 <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#222222] bg-purple-500/10 text-purple-400 font-mono text-xs mb-4">
 ...
 The <span className="text-transparent bg-clip-text bg-[#111111] from-red-500 ">Autonomic Board</span>
 </h1>
 ...
 <div className="w-16 h-16 rounded-2xl bg-[#111111] from-green-500/20 flex items-center justify-center mb-6">
 ...
 <div key={verdict.id} className="relative bg-[#0A0A0A]/60 backdrop-blur-xl border border-red-500/20 p-8 clip-corner-4 hover:border-red-500/50 transition-colors ">
 ...
 <div className="bg-black/80 border border-[#222222] p-5 rounded-lg shadow-[inset_0_0_20px_rgba(59,130,246,0.05)]">
 ...
 <div className="relative z-10 bg-[#111111] to-black border border-purple-500/60 p-6 rounded-lg clip-corner-2 hover: transition-all">
 ...
 <button className="px-6 py-2 bg-purple-600 hover:bg-purple-500 text-white font-bold font-mono text-sm rounded border border-purple-400 transition-all hover:scale-[1.02]">
