...
export default function CoFounderMatch() {
 ...
 <div className="bg-gray-800/40 border border-[#222222] rounded-2xl p-6 space-y-4">
 <div>
 ...
 className="w-full bg-[#111111] border border-[#222222] rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-blue-500 outline-none"
 ...
 className="w-full bg-[#111111] border border-[#222222] rounded-lg px-4 py-3 text-white outline-none"
 ...
 className="w-full bg-[#111111] border border-[#222222] rounded-lg px-4 py-3 text-white outline-none h-24"
 value={profile.bio}
 ...
 onClick={handleMatch}
 disabled={loading}
 className={`w-full py-3 rounded-xl font-bold text-white transition flex items-center justify-center gap-2 ${loading ? 'bg-blue-600/50 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-500 shadow-lg '
 }`}
 >
 {loading ? (
 <>
 ...
 <div className="h-full flex flex-col items-center justify-center text-gray-500 border-2 border-dashed border-[#222222] rounded-2xl p-8 min-h-[400px]">
 ...
 {matches.map((match) => (
 <div key={match.id} className="bg-gray-800/60 border border-[#222222]/50 hover:border-blue-500/50 transition rounded-xl p-5 group relative overflow-hidden">
