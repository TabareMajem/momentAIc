...
const TIER_CONFIG = {
 micro: { name: 'Micro', rate: '20%', icon: '🌱', color: 'from-green-500/20 ', followers: '<10k' },
 mid: { name: 'Rising Star', rate: '25%', icon: '⭐', color: 'from-yellow-500/20 ', followers: '10k-100k' },
 macro: { name: 'Macro', rate: '30%', icon: '🚀', color: 'from-purple-500/20 ', followers: '>100k' },
};
...
function StatCard({ label, value, icon: Icon, color, trend }: {
 ...
 return (
 <Card className={cn("p-4 bg-[#111111] border", color)}>
...
function SwipeFileGallery() {
 ...
 <div className="h-32 bg-[#111111] border-b border-white/5 relative overflow-hidden group">
 {/* Using dynamic blurred styling for the mockup images */}
 <div className="absolute inset-0 bg-[#111111] from-purple-500/20 " />
...
export default function AmbassadorDashboard() {
 ...
 icon={DollarSign}
 color="from-green-500/20 border-green-500/20"
 trend={15}
 />
 <StatCard
 label="Available"
 ...
 icon={Target}
 color="from-purple-500/20 border-purple-500/20"
 />
 <StatCard
 label="Conversion Rate"
 value={`${profile.conversion_rate}%`}
 icon={BarChart2}
 color="from-orange-500/20 border-orange-500/20"
 />
 </div>
 ...
 {/* Tier Progress */}
 <Card className={cn("p-6 border bg-[#111111]", tierConfig.color)}>
