...
export default function VisionPortal() {
 ...
 BUILD YOUR <span className="text-transparent bg-clip-text bg-[#111111] from-[#00f0ff] ">UNICORN</span>
 </h1>
 ...
 <div 
 className="h-full bg-[#111111] from-[#00f0ff] transition-all duration-500" 
 ...
 <Button variant="cyber" size="lg" className="animate-pulse " onClick={handleGenerate}>
 ...
 <div className="flex-1 bg-black border border-[#222222] rounded-lg p-4 font-mono text-sm text-green-500 overflow-hidden flex flex-col opacity-50">
 <div className="flex items-center gap-2 text-gray-500 border-b border-[#222222] pb-2 mb-2">
 ...
 <div className="w-20 h-20 bg-green-500/20 rounded-full flex items-center justify-center border border-green-500 text-green-500 mb-4 ">
