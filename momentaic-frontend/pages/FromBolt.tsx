...
export default function FromBolt() {
 ...
 {/* Animated Background */}
 <div className="fixed inset-0 bg-[#111111] from-yellow-900/20 via-transparent pointer-events-none" />
 ...
 Your app shipped
 <span className="bg-[#111111] from-yellow-400 bg-clip-text text-transparent"> instantly</span>.
 <br />
 ...
 disabled={!url.trim()}
 className="absolute right-3 top-3 p-3 bg-[#111111] from-yellow-400 rounded-xl text-black hover:opacity-90 disabled:opacity-50 transition-all shadow-lg shadow-yellow-500/20"
 >
 ...
 <Button
 onClick={handleLaunch}
 className="bg-[#111111] from-yellow-400 text-black font-black text-lg px-12 py-6 rounded-2xl hover: transition-all"
 >
