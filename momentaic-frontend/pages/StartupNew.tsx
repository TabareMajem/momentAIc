...
export default function StartupNew() {
 ...
 <div className="w-10 h-10 rounded-lg bg-[#111111] from-[#00f0ff] to-[#0066ff] flex items-center justify-center">
 ...
 <div className="w-16 h-16 rounded-full bg-[#111111] from-[#00f0ff]/20 to-[#0066ff]/20 flex items-center justify-center mx-auto mb-4 animate-pulse">
