...
export function GlobalCampaign() {
 ...
 <div>
 <h1 className="text-3xl font-bold flex items-center gap-3 bg-clip-text text-transparent bg-[#111111] from-blue-400 ">
 ...
 <div className="absolute inset-0 bg-[#111111] from-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
 ...
 : 'bg-[#111111] from-emerald-500 hover:from-emerald-400 hover: text-white '
 }`}
 >
 {isDeploying ? (
 ...
 <div className="absolute bottom-4 left-4 right-4 bg-black/80 backdrop-blur-md border border-[#222222] rounded-lg p-4 font-mono text-[11px] text-emerald-400 space-y-1 z-20">
