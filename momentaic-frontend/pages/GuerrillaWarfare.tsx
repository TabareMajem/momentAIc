...
export default function GuerrillaWarfare() {
 ...
 <span className="text-transparent bg-clip-text bg-[#111111] from-red-600 drop-">
 Asymmetric Warfare
 </span>
 </h1>
 ...
 {/* Target Acquisition */}
 <div className="bg-[#0A0A0A] border border-red-500/30 p-8 rounded-xl relative overflow-hidden mb-8 ">
 ...
 className="px-8 py-3 bg-red-600 hover:bg-red-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold font-mono text-sm rounded transition-all flex items-center gap-2"
 >
