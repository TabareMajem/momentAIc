...
const InnovatorLab: React.FC = () => {
 ...
 <h1 className="text-3xl font-bold bg-[#111111] from-purple-400 bg-clip-text text-transparent flex items-center gap-2">
...
const GrowthMonitorWidget = () => {
 ...
 target="_blank"
 rel="noreferrer"
 className="text-sm bg-blue-600/20 text-blue-300 hover:bg-blue-600/30 px-3 py-1 rounded border border-[#222222]"
 >
 Open Thread
 </a>
 </div>
...
const WarGamingWidget = () => {
 ...
 <div className="bg-[#111111] from-red-900/40 to-black border border-red-500/30 rounded-xl p-8 text-center relative overflow-hidden">
...
const TabButton = ({ active, onClick, icon, label }: any) => (
 ...
 : 'border-transparent text-gray-400 hover:text-gray-200 hover:border-[#222222]'}
 `}
 >
 {icon}
 {label}
