...
function XRayPanel({ reasoning }: { reasoning?: { research_analyzed?: string; options_considered?: string[]; final_decision_rationale?: string } }) {
 ...
 {isOpen && (
 <div className="mt-4 relative overflow-hidden bg-black/80 backdrop-blur-md border border-[#00f0ff]/30 rounded-xl p-5 animate-fade-in group">
 ...
 <div className="space-y-1 pl-3 border-l border-[#222222]">
...
export default function AgentChat() {
 ...
 {/* Chat Terminal */}
 <div className="flex-1 flex flex-col overflow-hidden bg-[#0A0A0A] border border-white/10 rounded-xl relative">
 ...
 >
 {msg.role === 'assistant' && (
 <div className="w-8 h-8 rounded-lg bg-[#2563eb]/20 border border-[#2563eb]/50 flex items-center justify-center flex-shrink-0 mt-1 ">
 ...
 msg.role === 'user'
 ? "bg-[#2563eb] text-white rounded-tr-none border border-[#2563eb] "
