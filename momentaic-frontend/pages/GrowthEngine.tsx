...
const sops = [
 ...
 { text: "Quality check: compare 10 test outputs against real footage — aim for 95%+ indistinguishability", done: false },
 ...
 { text: "Add to prospect database with all fields populated — no incomplete profiles", done: false },
 ],
 },
 {
 id: "sop-4",
 ...
 { text: "Pair video with message: 'The type of life you'll live if you reply 🏎️'", done: false },
 ...
 { text: "Walk through each SOP live on video call — record for future hires", done: false },
 ...
 { text: "Set daily standup: 15 min async Loom — what was done, blockers, quality flags", done: false },
...
const hookTypes = [
 { type: "Pattern Interrupt", icon: "⚡", example: "I just sent this to a CEO who ghosted me for 3 weeks...", color: "#ff3366" },
 { type: "Bold Claim", icon: "🔥", example: "This single DM strategy generated $47K in dead lead revenue last month.", color: "#ff6b35" },
 { type: "Question Hook", icon: "❓", example: "What would you do if you could clone yourself 1000 times?", color: "#ffd700" },
 { type: "Story Open", icon: "📖", example: "6 months ago I was manually recording every follow-up video...", color: "#7c4dff" },
 { type: "Stat Bomb", icon: "📊", example: "31% of people who completely ghosted us replied to this one thing.", color: "#00e5ff" },
];
...
const yokaizenAdaptations = [
 ...
 description: "Instead of lifestyle flex videos, generate personalized anime-style quest completion videos. When a Gen Z user drops off the Yokaizen app, send them an AI-generated video of their avatar completing a confidence challenge — 'Your quest awaits, [name]. The dragon of self-doubt doesn't stand a chance.'",
 ...
 description: "Generate unique anime-style progress videos for each user showing their growth journey. Biometric ring data feeds the AI — heart rate improvements, sleep quality gains — visualized as their avatar leveling up in the game world.",
 tools: "Grok Imagine + Biometric API + Flutter WebView",
 metric: "User retention & NPS",
 },
 {
 original: "$27 Low-Ticket Funnel",
 adapted: "Freemium → Premium Journey",
...
function Checkbox({ checked, onChange, label }: any) {
 ...
 {checked && <span style={{ color: "#00ff88", fontSize: 12, fontWeight: 800 }}>✓</span>}
 </div>
 <span style={{
 fontSize: 13,
...
return (
 ...
 <div style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", marginTop: 2 }}>Nano Banana Pro × Grok Imagine × IG System</div>
 </div>
 ...
 <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)" }}>⏱ {sop.time}</span>
 <span style={{ fontSize: 11, color: "rgba(255,255,255,0.3)" }}>📁 {sop.category}</span>
 </div>
 </div>
 <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
 <div style={{ textAlign: "right" }}>
 ...
 "The type of life you'll live if you reply 🏎️"
 </div>
 </div>
 </div>
 )}
