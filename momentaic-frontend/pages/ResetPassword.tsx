...
export default function ResetPassword() {
 ...
 <Card className="w-full max-w-md border-white/10 bg-[#0A0A0A]/80 backdrop-blur-xl">
 ...
 <div className="mx-auto w-12 h-12 bg-[#00f0ff]/10 rounded-full flex items-center justify-center mb-4 border border-[#00f0ff]/20 ">
