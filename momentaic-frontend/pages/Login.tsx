...
export default function LoginPage() {
 ...
 setError('Account exists with a different sign-in method. Please use GitHub or Email/Password.');
 } else {
 ...
 console.error(err);
 if (err.code === 'auth/account-exists-with-different-credential') {
 setError('Account exists with a different sign-in method. Please use Google or Email/Password.');
 } else {
 ...
 <Card className="border-white/5 bg-[#0A0A0A]/80 backdrop-blur-xl shadow-2xl">
 ...
 <Link to="/forgot-password" className="text-xs text-gray-500 hover:text-purple-400 font-medium transition-colors">Forgot password?</Link>
 </div>
 </div>
 </CardContent>
 ...
 <Button
 type="submit"
 className="w-full h-11 text-base bg-[#111111] from-purple-600 hover:from-purple-500 hover: text-white font-medium rounded-xl shadow-lg border-0"
 isLoading={isLoading}
 >
 Sign In
 </Button>
 ...
 <Link to="/signup" className="text-purple-400 hover:text-white font-medium transition-colors">
 Sign up
 </Link>
 </div>
 </CardFooter>
