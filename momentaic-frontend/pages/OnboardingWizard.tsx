...
export default function OnboardingWizard() {
 ...
 <h1 className="text-4xl md:text-5xl font-black font-mono tracking-tighter mb-4 text-transparent bg-clip-text bg-[#111111] from-white uppercase">
 60-Second Setup
 </h1>
 ...
 disabled={!url}
 className="w-full bg-[#00f0ff] text-black hover:bg-white font-bold h-12 rounded-lg uppercase tracking-widest hover: transition-all"
 >
 ...
 <div className="absolute -top-2 left-4 bg-[#0A0A0A] px-2 text-[10px] text-[#00f0ff] font-mono uppercase tracking-widest border border-[#00f0ff]/20 rounded">
 Proposed Viral Post
 </div>
 ...
 className="w-full bg-green-500 text-black hover:bg-white font-bold h-12 rounded-lg uppercase tracking-widest hover: transition-all"
 >
