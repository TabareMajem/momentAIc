...
const HoldToDeployButton = ({ onComplete }: { onComplete: () => void }) => {
 ...
 {/* Progress Fill */}
 <div
 className="absolute left-0 top-0 bottom-0 bg-[#111111] from-purple-600 transition-all duration-75 ease-out"
...
export default function GeniusOnboarding() {
 ...
 >
 <h1 className="text-3xl sm:text-5xl font-black mb-2 sm:mb-4 tracking-tighter text-transparent bg-clip-text bg-[#111111] from-white via-white ">
 ...
 inputValue.trim()
 ? "bg-[#111111] from-purple-600 text-white hover:"
 ...
 className="absolute inset-6 bg-[#111111] from-purple-600 rounded-full blur-xl"
 />
 ...
 <div className="w-10 h-10 rounded-xl bg-[#111111] from-purple-500 flex items-center justify-center">
