...
export default function TelemetryCore() {
 ...
 <span className="text-transparent bg-clip-text bg-[#111111] from-[#00f0ff] drop-">
 Cohort Intelligence
 </span>
 </h1>
 ...
 <div className="bg-[#0A0A0A] border border-white/10 p-6 rounded-xl relative overflow-hidden group hover:border-[#00f0ff]/50 transition-colors">
 ...
 <div className="bg-[#0A0A0A] border border-white/10 p-6 rounded-xl relative overflow-hidden group hover:border-purple-500/50 transition-colors">
 ...
 <div className="bg-[#0A0A0A] border border-red-500/30 p-6 rounded-xl relative overflow-hidden group shadow-[inset_0_0_20px_rgba(239,68,68,0.05)]">
 ...
 {/* Cohort Matrix */}
 <div className="bg-[#0A0A0A] border border-white/10 rounded-xl overflow-hidden mb-8">
