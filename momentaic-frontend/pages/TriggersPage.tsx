...
export default function TriggersPage() {
 ...
 {/* IF BLOCK */}
 <div className="relative border border-[#222222] rounded-lg p-6 bg-[#111111]/50 pt-8 mt-4">
 ...
 : 'border-[#222222] hover:border-gray-600 hover:bg-gray-800/50 text-gray-400'
 }`}
 >
 ...
 <div className="bg-[#111111] p-3 rounded-full border-2 border-[#222222] shadow-xl">
 <ArrowRight className="w-6 h-6 text-gray-400 transform rotate-90" />
 </div>
 </div>

 {/* THEN BLOCK */}
 <div className="relative border border-[#222222] rounded-lg p-6 bg-[#111111]/50 pt-8">
 ...
 <div className="relative border border-[#222222] rounded-lg p-6 bg-[#111111]/50 pt-8 animate-in fade-in duration-300">
 <div className="absolute -top-3 left-6 bg-brand-cyan/20 border border-brand-cyan/50 text-brand-cyan px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
 TARGET SWARM
 </div>
 <select className="w-full bg-black/50 border-2 border-[#222222] text-white text-base rounded-xl focus:ring-brand-cyan focus:border-brand-cyan block p-4 mt-2">
 ...
 <div className="flex justify-end gap-4 pt-6 border-t border-[#222222]">
 <Button variant="ghost" onClick={() => setIsCreating(false)} className="px-6">Cancel</Button>
 <Button variant="cyber" disabled={!selectedEvent || !selectedAction} onClick={handleSave} className="px-8 ">
 Activate Protocol
 </Button>
 </div>
 ...
 <Card key={rule.id} className="border-[#222222] bg-[#111111]/40 hover:bg-[#111111]/60 hover:border-[#222222] transition-all group">
 ...
 {rule.name}
 <Badge variant="cyber" className="bg-green-500/10 text-green-400 border-green-500/20 text-[10px] py-1 px-2 uppercase tracking-widest ">Active</Badge>
 </h3>
 <div className="flex items-center gap-3 text-sm text-gray-400 mt-3">
 <Badge className="bg-black/50 text-gray-300 font-medium px-3 py-1 border-[#222222]">IF {rule.event}</Badge>
 ...
 <Button variant="outline" className="w-full sm:w-auto text-gray-300 hover:text-white border-[#222222] hover:border-gray-500">View Logs</Button>
 <Button variant="outline" className="w-full sm:w-auto text-rose-400 hover:bg-rose-500/10 hover:text-rose-400 border-[#222222] hover:border-rose-500/30">Suspend</Button>
 </div>
 </CardContent>
 </Card>
 ))}

 <div className="text-center p-12 border-2 border-dashed border-[#222222] rounded-2xl bg-[#111111] from-black/0 mt-6 relative overflow-hidden group hover:border-[#222222] transition-colors">
 ...
 <div className="p-4 bg-[#111111] rounded-full border border-[#222222] mb-4 shadow-xl">
