...
const StepIndicator = ({ currentStep, steps }: { currentStep: number, steps: any[] }) => (
 ...
 <div
 className="absolute top-1/2 left-0 h-1 bg-[#111111] from-purple-500 -z-10 -translate-y-1/2 rounded-full transition-all duration-500 ease-out"
 ...
 currentStep === idx ? "bg-[#0a0a0a] border-[#00f0ff] text-[#00f0ff] " :
...
const StepCard = ({ children, title, description, isActive }: { children: React.ReactNode, title: string, description: string, isActive: boolean }) => (
 ...
 <Card className="bg-[#0A0A0A] border-white/10 h-full overflow-hidden">
...
export default function EmpireBuilder() {
 ...
 <div className="absolute top-0 left-0 w-full h-1 bg-[#111111] from-purple-500 opacity-50"></div>
 ...
 <div className="bg-[#111111]/50 p-4 rounded-lg border border-white/5 mb-6">
 ...
 <div className="w-24 h-24 bg-[#111111] from-purple-500 rounded-full mx-auto flex items-center justify-center animate-pulse ">
