...
function AgentNode({ data }: { data: any }) {
 ...
 return (
 <div
 className="relative bg-black/80 backdrop-blur-xl border border-white/10 rounded-xl p-4 min-w-[240px] transition-all hover:scale-[1.02] hover: group overflow-hidden"
...
export default function AgentComposability() {
 ...
 className="h-9 px-6 bg-[#111111] from-purple-600 hover:from-purple-500 hover: text-white font-mono text-xs shadow-lg "
 >
