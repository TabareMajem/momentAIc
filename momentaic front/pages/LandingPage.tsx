...
`
  ...
  return (
    <div className="min-h-screen bg-[#020202] text-white font-sans selection:bg-[#00f0ff] selection:text-black overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 z-10 max-w-7xl mx-auto min-h-[90vh] flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="space-y-8 order-2 lg:order-1 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 border border-[#00f0ff]/30 bg-[#00f0ff]/5 px-3 py-1 rounded font-mono text-[#00f0ff] text-[10px] tracking-[0.2em] uppercase backdrop-blur-md animate-fade-in-up" style={{ animationDelay: '0ms' }}>
                    <Terminal className="w-3 h-3" />
                    <DecodeText text="V2.0 // NEURAL UPLINK ESTABLISHED" />
                </div>
                
                <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black leading-[0.85] tracking-tighter uppercase relative animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                    <span className="block text-white mix-blend-overlay opacity-50 absolute top-1 left-1 blur-[1px] select-none">OUTBUILD THE</span>
                    <span className="block text-white relative z-10">OUTBUILD THE</span>
                    
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#a855f7] via-[#3b82f6] to-[#00f0ff] relative z-10">
                         GIANTS.
                    </span>
                    <span className="block text-[#00f0ff] absolute bottom-1 left-1 opacity-30 mix-blend-color-dodge blur-[2px] select-none">GIANTS.</span>
                </h1>
                
                <p className="text-lg text-gray-400 font-mono max-w-xl leading-relaxed mx-auto lg:mx-0 tracking-tight border-l-2 border-white/10 pl-4 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                    <ElegantText text="Turn your side project into a Silicon Valley contender. The AI Operating System that gives you the firepower of a 50-person team. No VC required. Keep 100% equity." delay={800} />
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '600ms' }}>
                    <Link to="/signup" className="w-full sm:w-auto">
                        <Button size="lg" variant="cyber" className="w-full sm:w-auto h-14 text-sm px-10 shadow-[0_0_40px_rgba(59,130,246,0.4)] border-[#00f0ff]/50">
                            DEPLOY_AGENTS <ArrowRight className="ml-2 w-4 h-4" />
                        </Button>
                    </Link>
                    <button onClick={() => scrollToSection('terminal')} className="w-full sm:w-auto">
                        <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 text-sm px-8 border-white/10 hover:bg-white/5 text-gray-300 font-mono tracking-widest group">
                            <Play className="mr-2 w-3 h-3 group-hover:text-[#00f0ff]" />
                            SYSTEM_DEMO
                        </Button>
                    </button>
                </div>
            ...
            <div className="relative h-[600px] w-full flex items-center justify-center order-1 lg:order-2 animate-fade-in-up" style={{ animationDelay: '800ms' }}>
                 <TiltCard className="relative w-[360px] h-[700px] bg-[#050505] border border-white/10 rounded-[3rem] shadow-2xl z-10">
                    {/* Screen Content */}
        ...
        <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
                <h2 className="text-3xl md:text-5xl font-black uppercase mb-6 tracking-tighter text-white">
                    Clearance <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-brand-blue">Levels</span>
                </h2>
                <p className="text-gray-400 font-mono text-xs uppercase tracking-widest">Select your authorization protocol.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="group relative">
                    ...
                    <Card className="border-white/10 bg-[#0a0a0a] relative h-full">
                        <CardHeader className="border-b border-white/5 pb-6">
                            <div className="font-mono text-[10px] text-gray-500 uppercase tracking-widest mb-2">Level 1</div>
                            <CardTitle className="text-3xl font-black text-white italic">STARTER</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-8 pt-8">
                            ...
                            <ul className="space-y-4 text-xs font-mono text-gray-400 uppercase tracking-wide">
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-white rounded-full"></div> 1 Active Entity</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-white rounded-full"></div> Basic Neural Agent</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-white rounded-full"></div> Sprint Command</li>
                            </ul>
                            <Button 
                                className="w-full h-12 border-white/20 hover:bg-white text-black bg-white" 
                                variant="default"
                    ...
                    <Card className="border-[#a855f7]/50 bg-[#0c0c0c] relative h-full shadow-[0_0_50px_rgba(168,85,247,0.1)]">
                        ...
                        <CardHeader className="border-b border-white/5 pb-6">
                            <div className="font-mono text-[10px] text-[#a855f7] uppercase tracking-widest mb-2 flex justify-between">
                                Level 2 <span>MOST POPULAR</span>
                            </div>
                            <CardTitle className="text-3xl font-black text-white italic">GROWTH</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-8 pt-8">
                            <div className="text-5xl font-black text-white font-sans">$49<span className="text-sm text-gray-500 font-normal">/mo</span></div>
                            <ul className="space-y-4 text-xs font-mono text-gray-300 uppercase tracking-wide">
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#a855f7] rounded-full"></div> 3 Active Entities</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#a855f7] rounded-full"></div> Sales & Dev Swarm</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#a855f7] rounded-full"></div> Signal Velocity Radar</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#a855f7] rounded-full"></div> Priority Compute</li>
                            </ul>
                            <Button 
                ...
                {/* God Mode */}
                <div className="group relative">
                    <div className="absolute inset-0 bg-gradient-to-b from-[#00f0ff]/10 to-transparent rounded-2xl transform transition-transform group-hover:scale-[1.02] duration-300"></div>
                    <Card className="border-[#00f0ff]/30 bg-[#0a0a0a] relative h-full">
                        <CardHeader className="border-b border-white/5 pb-6">
                            <div className="font-mono text-[10px] text-[#00f0ff] uppercase tracking-widest mb-2">Level 3</div>
                            <CardTitle className="text-3xl font-black text-[#00f0ff] italic">GOD MODE</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-8 pt-8">
                            <div className="text-5xl font-black text-white font-sans">$99<span className="text-sm text-gray-500 font-normal">/mo</span></div>
                            <ul className="space-y-4 text-xs font-mono text-gray-400 uppercase tracking-wide">
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#00f0ff] rounded-full"></div> Unlimited Entities</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#00f0ff] rounded-full"></div> Full Swarm Access</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#00f0ff] rounded-full"></div> Dedicated Neural Node</li>
                                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-[#00f0ff] rounded-full"></div> API Key Access</li>
                            </ul>
                            <Button 
                                className="w-full h-12 border-[#00f0ff]/50 text-[#00f0ff] hover:bg-[#00f0ff] hover:text-black" 
                                variant="outline"
      ...
      {/* --- MANIFESTO (RAW TEXT) --- */}
      <section className="py-20 px-6 bg-black border-t border-white/10 font-mono text-xs text-gray-500">
          <div className="max-w-2xl mx-auto space-y-4">
              <div className="text-[#00f0ff] mb-4">root@moment-os:~/manifesto.txt</div>
              <p>>> THE OLD WAY IS DEAD.</p>
              <p>>> HUMAN CAPITAL IS THE BOTTLENECK. EMOTION IS LATENCY. SLEEP IS DOWNTIME.</p>
              <p>>> WE BUILT MOMENT.AI.C NOT TO ASSIST YOU, BUT TO SCALE YOU.</p>
              <p>>> THIS IS NOT A TOOL. THIS IS AN INFRASTRUCTURE FOR GODS.</p>
      ...
      <section className="py-40 px-6 bg-[#050505] relative overflow-hidden border-t border-white/5">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#00f0ff] opacity-[0.05] blur-[150px] rounded-full pointer-events-none"></div>
          
          <div className="relative z-10 max-w-4xl mx-auto text-center space-y-10">
              <h2 className="text-5xl md:text-8xl font-black text-white tracking-tighter leading-[0.85]">
                  READY TO<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500">ASCEND?</span>
              </h2>
              <div className="flex flex-col sm:flex-row justify-center gap-6 pt-8">
                  <Link to="/signup" className="w-full sm:w-auto">
                    <Button variant="cyber" size="lg" className="w-full sm:w-auto h-16 px-12 text-lg shadow-[0_0_50px_rgba(0,240,255,0.4)]">
                        INITIALIZE_SYSTEM
                    </Button>
                  </Link>
              </div>
