...
import {
  LayoutDashboard, Rocket, Bot, MessageSquare, TrendingUp, Settings, LogOut, Menu, X, ShieldAlert, Network, Eye, Zap, BarChart2, Plug, Bell, Trophy, Gift, Award, FlaskConical, Megaphone, Crown
} from 'lucide-react';
...
export function Sidebar() {
  ...
  const navigation = [
    ...
    { name: 'REFERRAL_ENGINE', href: '/referrals', icon: Gift },
    { name: 'SOCIAL_PROOF', href: '/social-proof', icon: Award },
    { name: 'EXPERIMENTS', href: '/experiments', icon: FlaskConical },
    { name: 'CAMPAIGNS', href: '/campaigns', icon: Megaphone },
    { name: 'AMBASSADOR', href: '/ambassador', icon: Crown },
